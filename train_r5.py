...
from r5.utils.env import collect_environment
from r5.utils.io import save_json, save_yaml, load_yaml, set_nested
from r5.utils.seed import seed_everything
...
def main():
    ...
    save_json({"source": "standalone SAGE_SAM_R5 generated from KnowSAM-style UNet and R3 engineering conventions"}, out / "source_versions.json")
    trainer = SAGESAMR5Trainer(config)
    if args.resume:
